export const vueHtml = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
export const vueMain = `import { createApp } from 'vue';
import App from './App.vue';

createApp(App).mount('#app');`;

export const vueCssMain = `import { createApp } from 'vue';
...
export const vueTailwindApp = `<template>
  <div id="app" class="w-[100vw] h-[100vh] flex flex-col items-center text-center bg-[linear-gradient(to_bottom,_#1f2544,_#272c4d,_#35395a,_#4a4e6d,_#6b6b85,_#83759a,_#a37aaf,_#d2a6cd)]">
    <h1 class="mt-[10rem] font-bold text-[2.5rem] text-[#f6f6f6]">
      ⚡ Electron-vite + <span class="text-[#20b2aa]">Vue</span>
    </h1>
